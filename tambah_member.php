          ...
          <!-- End of Topbar -->
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            //tambah data ke db
                            $sql = "INSERT INTO admin ( username, password, nama_lengkap) VALUES ( '$nama', '$password','$nama_lengkap')";
                    ...
                    <!DOCTYPE html>
                       ...
                       <style>
                          ...
                          .form-card button:hover {
                            background: linear-gradient(to right, #5e50d6, #8e82ff);
                        ...
                        <body>
                           <div class="form-card">
                              ...
                              <form action="" method="post">
                                ...
                                <input type="text" name="nama_lengkap" placeholder="Nama Lengkap Admin" required>
