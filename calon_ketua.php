...
<html lang="en">
  ...
  <h2>Daftar Calon OSIS</h2>
  <div class="nav-itemk">
  <a class="btn btn-outline-primary btn-sm mb-3 me-3" target="_blank" href="addcalon.php">+ ketua baru</a>
  </div>

<div class="card-container">
<?php
$result = $koneksi->query("SELECT * FROM calon_ketua ORDER BY id_calon DESC");
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p><strong>Visi:</strong> " . nl2br(htmlspecialchars($row['visi'])) . "</p>";
        echo "<p><strong>Kelas:</strong> " . htmlspecialchars($row['kelas']) . "</p>";
        echo "<a href='inputcalon.php?id=" . $row['id_calon'] . "'>Edit</a>";
        echo "<br><a href='hapusin.php?id_calon=" . $row['id_calon'] . "' onclick=\"return confirm('Yakin ingin menghapus?')\"> Hapus</a>";

        echo "</div></div>";
    }
} else {
    echo "<p>Belum ada data calon OSIS.</p>";
}
?>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto mb-0">
