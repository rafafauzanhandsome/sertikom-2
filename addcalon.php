...
<html lang="en">
 ...
 <?php
    ...
    // buat variabel buat deteksi mode edit atau tambah
    $edit_mode = false;
    $data = [];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($foto_name)) {
            ...
            $foto_path = ''; // kalau kosong
        }

        // insert ke database
        $sql = "INSERT INTO calon_ketua (nama, visi, kelas, foto) VALUES ('$nama', '$visi', '$kelas', '$foto_path')";
        $query = mysqli_query($conn, $sql);

        if ($query) {
            echo "<script>alert('Data berhasil ditambahkan');location='calon_ketua.php';</script>";
        } else {
